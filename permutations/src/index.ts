/**
 * 1. Algorithmic Complexity: O(O(numberOfZero + numberOfOne))
 * 2. Get basic mutation etc.
...
/**
 * 1. Algorithmic Complexity: O(numberOfMutations)
 * 2. Get unique mutation etc. if perms = [[1,2,3],[1,2,3]] -> [1,2,3]
...
/**
 * 1. Algorithmic Complexity: O(i^n)
 * 2. Get array mutation etc.
...
/**
 * 1. Algorithmic Complexity: O(numberOfTargetPhase)
 * 2. Get input with * replace with mutation
